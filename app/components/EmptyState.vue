...
// Generic centred empty/placeholder state: icon bubble, title, optional
// description, and an optional action slot (e.g. a CTA button).
defineProps<{
  icon: string;
  title: string;
  description?: string;
...
<template>
  ...
  >
    ...
    >
      <NuxtIcon :name="icon" class="size-6" />
    </div>
    <div class="space-y-1">
